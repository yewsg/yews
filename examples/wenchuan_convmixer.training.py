...
from yews.models import convmixer
...
if __name__ == '__main__':
    ...
    dset = dsets.Wenchuan(path='/data/wenchuan', download=False,sample_transform=waveform_transform)
    ...
    # Prepare trainer
    trainer = Trainer(convmixer(), CrossEntropyLoss(), lr=0.01)
